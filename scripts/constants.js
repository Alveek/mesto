...
export const formNewCardButton = formNewCard.querySelector(".form__button");
export const cardsContainer = document.querySelector(".card__items");
export const cardName = document.querySelector(".form__input_card_name");
export const cardLink = document.querySelector(".form__input_card_link");
